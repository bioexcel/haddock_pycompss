...
class SuffixError(Error):
    ...
    def __init__(self, target, suffix,
                 message="No PDB input matches the suffix"):
        self.suffix = suffix
        self.target = target
        self.message = message
        super().__init__(self.message)
...
class MultipleInputError(Error):
    ...
    def __init__(self, target, suffix,
                 message="More than one PDB input matches the suffix"):
        self.suffix = suffix
        self.target = target
        self.message = message
        super().__init__(self.message)
...
class HaddockError(Error):
    ...
    def __init__(self, output_file,
                 message="Haddock could not executed"):
