...
import time
import re
from modules.errors import (HeaderUndefined, ConfigKeyUndefinedError,
                            ConfigKeyEmptyError, PathNotFound,
                            ScenarioUndefined, InvalidRunName,
                            InvalidParameter)
...
class ConfigFile:
    ...
    def validate(self):
        ...
        if not shutil.which('ssub'):
            ...
            configlog.warning('ssub not in PATH, HADDOCK will fail if you are'
